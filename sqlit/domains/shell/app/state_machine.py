...
from sqlit.domains.explorer.ui.key_states import (
...
from sqlit.domains.shell.app.key_states import (
    LeaderPendingState,
    MainScreenState,
    ModalActiveState,
    QueryExecutingState,
...
from sqlit.domains.shell.app.leader_commands import (
    get_leader_bindings,
    get_leader_commands,
)
from sqlit.domains.shell.app.state_base import (
    ActionResult,
    DisplayBinding,
    HelpEntry,
    State,
...
class UIStateMachine:
    ...
    def get_active_state(self, app: UIContext) -> State:
    ...
    def check_action(self, app: UIContext, action_name: str) -> bool:
    ...
    def get_active_state_name(self, app: UIContext) -> str:
